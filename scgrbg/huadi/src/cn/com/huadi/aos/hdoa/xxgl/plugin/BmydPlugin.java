...
import cn.com.huadi.aos.hdoa.xxgl.service.BmydService;
 ...
 * @date 2017年9月11日
 */
public class BmydPlugin extends BasePlugin implements FormCreateListener,
SubmitListener {
			...
			if(userInfo!=null){
				...
				try {
					if (arg1.isAction("query")) {
							...
							List<Map> list = this.getBmydService().queryByPage(arg1);
	...
	*/
	...
	// 获得BmybService对象
	public BmydService getBmydService() {
		return new BmydService();
	}
