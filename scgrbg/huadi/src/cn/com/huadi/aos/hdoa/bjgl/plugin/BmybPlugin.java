 ...
 * @date 2017年9月11日
 */
public class BmybPlugin extends BasePlugin implements FormCreateListener,
SubmitListener {
			...
			if(userInfo!=null){
				...
				try {
					if (arg1.isAction("query")) {
							...
							List<Map> list = this.getBmybService().queryByPage(arg1);
							list = convert(list);
	...
	// 获得BmybService对象
	public BmybService getBmybService() {
		return new BmybService();
	}
