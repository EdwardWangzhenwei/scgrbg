...
import cn.com.huadi.aos.hdoa.yjgl.service.GryyService;
 ...
 * @date 2017年9月11日
 */
public class GryyPlugin extends BasePlugin implements FormCreateListener,
SubmitListener {
			...
			if(userInfo!=null){
				...
				try {
					if (arg1.isAction("query")) {
							...
							List<Map> list = this.getGryyService().queryByPage(arg1);
							list = convert(list);
	...
	// 获得GrybService对象
	public GryyService getGryyService() {
		return new GryyService();
	}
