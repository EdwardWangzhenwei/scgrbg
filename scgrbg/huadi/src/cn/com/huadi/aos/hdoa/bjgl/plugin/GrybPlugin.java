 ...
 * @date 2017年9月11日
 */
public class GrybPlugin extends BasePlugin implements FormCreateListener,
SubmitListener {
			...
			if(userInfo!=null){
				...
				try {
					if (arg1.isAction("query")) {
							...
							List<Map> list = this.getGrybService().queryByPage(arg1);
							list = convert(list);
	...
	// 获得GrybService对象
	public GrybService getGrybService() {
		return new GrybService();
	}
