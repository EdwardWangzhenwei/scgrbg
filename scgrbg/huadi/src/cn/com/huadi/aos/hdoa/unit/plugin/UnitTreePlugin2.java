...
import cn.com.huadi.aos.hdoa.unit.service.UnitTreeService2;
 ...
 *2015-9-4下午02:39:54
 */
public class UnitTreePlugin2 implements SelectOptionGetter,
		SubmitListener {
	
	public UnitTreeService2 getUnitTreeService2(){
		return new UnitTreeService2();
	}

	@Override
	public List<Map> getOptions(DataMsgBus bus) {
		List<Map> res=getUnitTreeService2().getTreeData(bus);
		return res;
	}
