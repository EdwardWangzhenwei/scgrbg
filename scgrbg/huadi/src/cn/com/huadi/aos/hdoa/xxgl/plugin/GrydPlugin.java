...
import cn.com.huadi.aos.hdoa.bjgl.service.GrybService;
...
import cn.com.huadi.aos.hdoa.xxgl.service.GrydService;
 ...
 * @date 2017年9月11日
 */
public class GrydPlugin extends BasePlugin implements FormCreateListener,
SubmitListener {
			...
			if(userInfo!=null){
				...
				try {
					if (arg1.isAction("query")) {
							...
							List<Map> list = this.getGrydService().queryByPage(arg1);
	...
	*/
	...
	// 获得GrybService对象
	public GrydService getGrydService() {
		return new GrydService();
	}
